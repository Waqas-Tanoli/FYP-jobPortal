...
const HeroSection = () => {
  return (
    <div className="flex justify-between pl-40 pr-40 mt-20 tracking-widest">
      <div className="">
        <h1 className="font-semibold leading-normal text-6xl text-[#040c1b]">
          The <span className="text-7xl text-[#8E3CCB]">#1 Job Site</span> to
          Find
      ...
      <Image src="/hero.png" height={500} width={500} alt="Image" />
    </div>
  );
};
